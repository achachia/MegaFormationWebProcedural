          ...
          <table>
               <tr>
                   <td style="border: solid 1px #000000; text-align:center;border-radius: 3mm;width:90%;height:50px;">                      
                      <table>
                        <tr>
                           <td style="text-align:center"  colspan='2'>Devis N 2014010001</td>
                        </tr>
                        <tr>
                           <td style="width:50%">Date : 20-01-2014</td> 
...
<table>
     <tr>
        ...
        <td style="border: solid 1px #000000; text-align:left;border-radius: 3mm;width:40%;height:80px;padding: 10px">
             Mr Mme PEYRAMAURE PASCAL<br/>
             6 rue Etienne Dolet<br/>
             69003 Lyon<br/>
             France<br/>
        </td>        
    </tr>
</table><br>
<b><u>Objet </u>:  Soutien scolaire</b><br><br> 
...
<table border="1" cellspacing="0" style="width:100%">
     <tr>
        ...
        <th style="text-align:center;width:11%">QTE</th>
        <th style="text-align:center;width:11%">PU HT</th>
        <th style="text-align:center;width:11%">REMISE(€)</th>
        <th style="text-align:center;width:16%">TOTAL HT</th>
     </tr>
     <tr>
        <td style="width:50%;height:280px;vertical-align: top">soutien scolaire, Niveau Terminale</td>
        <td style="width:11%;height:280px;vertical-align: top;text-align:center">4.00</td> 
        <td style="width:11%;height:280px;vertical-align: top;text-align:center">40.00</td>
          <td style="width:11%;height:280px;vertical-align: top;text-align:center">4.00</td>
        <td style="width:16%;height:280px;vertical-align: top;text-align:center">160.00 €</td>       
    </tr>   
</table><br/>
<table style="border:none;">
   <tr>
        <td  style="width:70%">
         ...
         <tr><td>Mode de paiement : Chèque</td></tr>
         </table><br/>
         Bon pour accord le <br/>
         Signature
       </td>      
