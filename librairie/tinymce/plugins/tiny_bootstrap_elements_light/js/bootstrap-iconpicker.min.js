...
;(function($){ "use strict";
            ...
            if (typeof option === 'string') {
                ...
                $this.on('click', function(e) {
                    ...
                    $this.popover({
                        ...
                        html: true,
                        content: op.table,
                        container: $this.closest('body').closest('body'),
    ...
    $(document).on('click', 'body', function (e) {
        $('.iconpicker', context).each(function () {
            //the 'is' for buttons that trigger popups
            //the 'has' for icons within a button that triggers a popup
            if (!$(this, context).is(e.target) && $(this, context).has(e.target).length === 0 && $('.popover', context).has(e.target).length === 0) {
                $(this, context).popover('destroy');
            }
        });
    });

    $('button[role="iconpicker"]', context).iconpicker();
