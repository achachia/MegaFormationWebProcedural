...
function list_exercices($keygen_theme, $keygen_groupe, $code_user) {
    global $cxn;
    $liste = array();
    $date_actuel = date("Y-m-d H:i:s");
    try {
        $sql = "    SELECT  Exercices_themes.date_created,Exercices_themes.titre_exo,Exercices_themes.contenu_exo,Exercices_themes.keygen_exo,Exercices_themes.img_exo"
                . ",Exercices_themes.aide_exo,Liste_plate_formes_codes.url,Liste_plate_formes_codes.nom_plate_forme,Liaison_exo_theme_user.date_publication_user,Liaison_exo_theme_user.date_limite_depot_user_travail"
                . ",Liaison_exo_theme_user.date_publication_corrige	  "
                . " FROM    Exercices_themes,Liaison_exo_theme_user,Liste_plate_formes_codes   "
                . " WHERE   Exercices_themes.keygen_exo= Liaison_exo_theme_user.fk_exo "
                . " AND  Exercices_themes.id_plate_forme=Liste_plate_formes_codes.id_plate_forme"
                . "  AND   Exercices_themes.fk_theme=:param1"
