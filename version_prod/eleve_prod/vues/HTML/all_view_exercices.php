...
<div class="row">
    <div class="col-md-12" style="margin-top:3%">
        <?php
        $j = 1;
        foreach ($list_exercices_html as $value) {
            ?>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            ...
                            <?php } ?>
                            <?php if ($_SESSION ['membre']['last_connection'] < $value['date_creation_exo']) { ?>
                                <span  style="color: red;background-color: #ece9e9;text-shadow: #474747 3px 5px 2px;">nouveau</span>
                            <?php } ?>
                        </h4>
                    </div>
                    <div id="collapse_<?= $value['keygen_exo']; ?>" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <!------------------------------------------------------------------->
                            <?php if ($value['date_limite_depot'] != '') { ?>
                                <button type="text" class="btn btn-danger"><i class="fa fa-calendar" aria-hidden="true"></i>  La date limite de depot : <?= $value['date_limite_depot']; ?></button>
                            <?php } ?>      
                            <!--------------------------------------------------------------------->
                            ...
                            if ($value['date_limite_depot'] > $date_jour) {
