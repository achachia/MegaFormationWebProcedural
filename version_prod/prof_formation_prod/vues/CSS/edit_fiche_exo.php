<div class="row"  style="margin-top:5%">
    <div class="col-lg-12">     
        <ol class="breadcrumb"  style="color:blue;font-size: 20px">
            ...
            <li><i class="fa fa-code" aria-hidden="true"></i><span class="separator"></span> CSS</li>
            <li><a href="<?= url_espace_formateur; ?>/index.php?module=CSS&action=all_view_exercices"><i class="fa fa-list" aria-hidden="true"></i><span class="separator"></span> LISTE DES EXERCICES</a></li>
...
<div class="col-md-12 column">
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <?php } ?>
            <form class="form-horizontal" id="form_add_exo" name="form_add_exo" method="POST" enctype="multipart/form-data"  action="<?= url_espace_formateur_prod; ?>/controleurs/CSS/traitement_edit_exo.php">                  
                ...
                <div class="form-group" style="padding-top:20px ">
                    ...
                    <div class="col-sm-8">
                        ...
                        <span class="label label-danger"  style="font-size:12px "><?= $list_erreur['select_etat_exo']; ?></span>
                    ...
                    <div class="col-sm-8">
                        ...
                        <select class="form-control" data-style="btn-primary" data-placeholder="Selectionnez une plate forme" 	id="select_plate_forme" name="select_plate_forme">                                       
                            <?php foreach ($liste_plate_forme_travail as $value) { ?>
                                ...
                                <?php
                                if ($infos_exo['id_plate_forme'] == $value['id_plate_forme']) {
                                    echo 'selected';
                                }
                                ?>                                  
                                        >
                ...
                <input type="hidden"   value="<?= $keygen_exo; ?>"   name="keygen_exo"    id="keygen_exo">
