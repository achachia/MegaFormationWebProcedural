...
<div class="row"  style="margin-top:5%">
    <div class="btn-group" role="group">
        <a href="<?= url_espace_formateur_prod; ?>/index.php?module=CSS&action=add_exo_css">
...
<div class="row">
    <div class="col-md-12" style="margin-top:3%">
        <?php
        $j = 1;
        foreach ($list_exercices_css as $value) {
            ?>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class=" col-lg-6  col-sm-12">
                                    <a class="btn btn-success"  href="<?= url_espace_formateur; ?>/index.php?module=CSS&action=edit_fiche_exo&keygen_exo=<?= $value['keygen_exo']; ?>">

                                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Modifier la fiche</a>
                                    <a class="btn btn-success" href="<?= url_espace_formateur; ?>/index.php?module=CSS&action=all_view_reponses_eleves&keygen_exo=<?= $value['keygen_exo']; ?>">
