    ...
    <div class="row">
        <div class="col-md-12">
            <table class="table">
                ...
                <tbody>
                   <?php $j=1; foreach ($list_fiches_cours_css as $value) { ?> 
                    <tr class="active">
                        <td>
                           <?= $j; ?>
                        </td>
                        <td>
                            <h4><a href="<?= url_espace_formateur; ?>/index.php?module=CSS&action=view_fiche_cours&id_fiche=<?= $value['id_fiche'] ?>"><?= $value['titre']; ?></a></h4>
                        </td>
