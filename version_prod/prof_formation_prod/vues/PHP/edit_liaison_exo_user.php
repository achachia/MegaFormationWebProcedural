...
<div class="row"  style="margin-top:5%">
    <div class="col-lg-12">     
        <ol class="breadcrumb"  style="color:blue;font-size: 20px">
            ...
            <li><span class="separator"></span> <?= $keygen_liaison; ?></li>
            <li style="color:#831098;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> MODIFIER UNE LIAISON EXO|GROUPE|USER</li>
        </ol>      
    </div>    
</div>
...
<div class="col-md-8 column">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 id="css_titre">
                <span class=" glyphicon glyphicon-pencil"></span> Modifier une liaison exercice - groupe | user
            </h3>
        </div>
        <div class="panel-body">
            ...
            <?php } ?>
            <form class="form-horizontal" id="form_add_liaison_exo_user" name="form_add_liaison_exo_user" method="POST"   action="<?= url_espace_formateur_prod; ?>/controleurs/<?= $module; ?>/traitement_edit_liaison_exo_user.php">                  
