<div class="row"  style="margin-top:5%">
    <div class="col-lg-12">     
        <ol class="breadcrumb"  style="color:blue;font-size: 20px">
            ...
            <li  style="color:#831098;"><a href="<?= url_espace_formateur_prod; ?>/index.php?module=<?= $module; ?>&action=view_exos_theme&token_theme=<?= $keygen_theme; ?>"><i class="fa fa-list" aria-hidden="true"></i><span class="separator"></span> LISTE DES EXERCICES</a></li>
...
<div class="col-md-12 column">
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">    
            ...
            <?php } ?>
            <form class="form-horizontal" id="form_add_exo" name="form_add_exo" method="POST" enctype="multipart/form-data"  action="<?= url_espace_formateur_prod; ?>/controleurs/<?= $module; ?>/traitement_edit_exo_theme.php">                  
                ...
                <div class="form-group" style="padding-top:20px ">
                    ...
                    <div class="col-sm-8">
                        ...
                        <span class="label label-danger"  style="font-size:12px "><?= $list_erreur['select_plate_forme']; ?></span>
