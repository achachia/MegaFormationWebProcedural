<div class="row"  style="margin-top:5%"> 
    <div class="col-lg-12">     
        <ol class="breadcrumb"  style="color:blue;font-size: 20px">
            ...
            <li><i class="fa fa-code" aria-hidden="true"></i><span class="separator"></span> PHP</li>
            <li><a href="<?= url_espace_formateur; ?>/index.php?module=PHP&action=all_view_fiches_cours"><i class="fa fa-list" aria-hidden="true"></i><span class="separator"></span> LISTE DES FICHES DE COURS</a></li>
