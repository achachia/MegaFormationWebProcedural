<div class="row"  style="margin-top:5%">
    <div class="col-lg-12">     
        <ol class="breadcrumb"  style="color:blue;font-size: 20px">
            ...
            <li><a href="<?= url_espace_formateur; ?>/index.php?module=HTML&action=all_view_exercices"><i class="fa fa-list" aria-hidden="true"></i><span class="separator"></span> LISTE DES EXERCICES</a></li>
...
<div class="col-md-12 column">
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <?php } ?>
            <form class="form-horizontal" id="form_add_exo" name="form_add_exo" method="POST" enctype="multipart/form-data"  action="<?= url_espace_formateur_prod; ?>/controleurs/HTML/traitement_edit_exo.php">                  
