...
<div class="row"  style="margin-top:5%">
    <div class="btn-group" role="group">
        <a href="<?= url_espace_formateur_prod; ?>/index.php?module=HTML&action=add_exo_html">
                    ...
                    <div id="collapse_<?= $value['keygen_exo']; ?>" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <div class="row">
                                    ...
                                    <a class="btn btn-success"  href="<?= url_espace_formateur; ?>/index.php?module=HTML&action=edit_fiche_exo&keygen_exo=<?= $value['keygen_exo']; ?>">

                                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Modifier la fiche</a>
                                    <a class="btn btn-success" href="<?= url_espace_formateur; ?>/index.php?module=HTML&action=all_view_reponses_eleves&keygen_exo=<?= $value['keygen_exo']; ?>">
