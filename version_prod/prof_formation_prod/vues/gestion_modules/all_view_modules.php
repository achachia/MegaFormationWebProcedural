<div class="row"  style="margin-top:5%">
    <div class="col-lg-12">     
        <ol class="breadcrumb"  style="color:blue;font-size: 20px">
            ...
            <li  style="color:#831098;"><i class="fa fa-list" aria-hidden="true"></i><span class="separator"></span> LISTE DES MODULES</li>
...
<div class="row"  style="margin-top:5%">
    <div class="btn-group" role="group">
        <a href="<?= url_espace_formateur_prod; ?>/index.php?module=<?= $module; ?>&action=add_module">
            ...
            foreach ($list_modules as $value) {
                ...
                <tr class="info">
                    ...
                    <td>
                        ...
                        <a href="<?= url_espace_formateur; ?>/index.php?module=<?= $module; ?>&action=all_view_themes&token_module=<?= $value['keygen_module']; ?>"   class="btn btn-primary">
