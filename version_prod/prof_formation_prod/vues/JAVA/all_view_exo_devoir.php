                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" href="#collapse_<?= $value['keygen_exo']; ?>"><?= $j . '. ' . $value['titre_exo']; ?></a> <span class="label label-info"><?= $value['nbr_points']; ?> points</span>&nbsp;&nbsp;<?= $value['etat_corrige_exo']; ?>
                    ...
                    <div id="collapse_<?= $value['keygen_exo']; ?>" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <a href="<?= $value['url_palte_forme'] . '/' . $value['code_fiddle_corrige_eleve']; ?>"  target="_blank" id="url_travail_<?= $value['keygen_exo']; ?>"><button type="text" class="btn btn-primary">La plate forme de travail : <?= $value['plate_forme']; ?></button></a>
                                <a class="btn btn-success" href="<?= url_espace_formateur; ?>/index.php?module=<?= $module; ?>&action=all_view_reponses_dev_eleves&token_dev=<?= $keygen_devoir; ?>&keygen_exo=<?= $value['keygen_exo']; ?>"><i class="fa fa-list-ol" aria-hidden="true"></i>  La liste des reponses postés</a>
                            <!------------------------------------------------------------>
