...
<div class="col-md-12 column">
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <?php } ?>
            <form class="form-horizontal" id="form_add_exo" name="form_add_exo" method="POST" enctype="multipart/form-data"  action="<?= url_espace_formateur_prod; ?>/controleurs/JAVA/traitement_edit_exo.php">                  
