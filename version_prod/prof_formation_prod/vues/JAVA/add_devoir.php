<div class="row"  style="margin-top:5%">
    <div class="col-lg-12">     
        <ol class="breadcrumb"  style="color:blue;font-size: 20px">
            ...
            <li style="color:#831098;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> AJOUTER UN NOUVEAU DEVOIR</li>
        </ol>      
    </div>    
</div>
...
<div class="col-md-12 column">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 id="css_titre">
                <span class=" glyphicon glyphicon-pencil"></span> Création un nouveau devoir
            </h3>
        </div>
        <div class="panel-body">
            ...
            <?php } ?>
            <form class="form-horizontal" id="form_add_dev" name="form_add_dev" method="POST"   action="<?= url_espace_formateur_prod; ?>/controleurs/<?= $module; ?>/traitement_add_dev.php">                  
                ...
                <input type="hidden"   value="<?= $infos_module['keygen_module']; ?>"   name="fk_module"    id="fk_module">
                <input type="hidden"   value="<?= $module; ?>"   name="nom_module"    id="nom_module">

                <hr/>
                <div class="form-group" style="padding-top:20px ">
                    <div class="col-lg-offset-8 col-lg-5  col-sm-offset-4 col-sm-5">
                        <button type="submit" class="btn btn-success">Enregistrer votre devoir</button>
                    </div>
                </div>
            </form>
        </div>
