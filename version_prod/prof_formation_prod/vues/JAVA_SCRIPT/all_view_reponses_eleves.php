<div class="row"  style="margin-top:5%">
    <div class="col-lg-12">     
        <ol class="breadcrumb"  style="color:blue;font-size: 20px">
            ...
            <li style="color:#831098;">  <?= $infos_exo['titre_exo']; ?></li>
        </ol>      
    </div>
    <!-- /.col-lg-12 -->
</div>
...
<div class="bootstrap snippet"  style="margin-left:5%">
    <div class="row">
            ...
            <div class="panel panel-default">
                <div class="panel-body p-t-0">
                    <div class="input-group">
                        <input type="text" id="barre_search" name="example-input1-group2" class="form-control" placeholder="Rechercher">
        ...
        <div class="col-lg-4">
            <div class="panel panel-default">
                <div class="panel-body p-t-0">
                    <select id="select_etat_code" name="select_etat_code" class="form-control">
                        <option value="">Choisir le statut</option>
                        <?php foreach ($list_statut_code as $value) { ?>
                            <option value="<?= $value['id_statut']; ?>"><?= $value['nom_statut']; ?>
                            </option>
                        <?php } ?>                                     
    ...
    <div class="row"  id="liste_reponses">
