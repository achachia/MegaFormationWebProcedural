...
<div class="col-md-12 column">
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">   
            ...
            <?php } ?>
            <form class="form-horizontal" id="form_add_exo" name="form_add_exo" method="POST" enctype="multipart/form-data"  action="<?= url_espace_formateur_prod; ?>/controleurs/<?= $module; ?>/traitement_add_exo_devoir.php">                  
                ...
                <div class="form-group">
                    <label class="control-label col-lg-3 col-md-3 col-sm-4"  for="img_exo"  style="color:blue;font-size:16px">Associer une image <span style="color:red">(<i class="fa fa-asterisk" aria-hidden="true"></i>)</span></label>
                ...
                <div class="form-group"  style="padding-top:1%">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="nbr_points"  name="nbr_points"  placeholder="Entrer nombre de points" value="<?= $infos_exo['nbr_points']; ?>" >
                        <span class="label label-danger"  style="font-size:12px "><?= $list_erreur['nbr_points']; ?></span>
                    </div>
                </div>


                <input type="hidden"   value="<?= $keygen_dev; ?>"   name="token_devoir"    id="token_devoir">
