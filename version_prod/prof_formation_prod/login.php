...
<html lang="fr">
    <head>
        ...
        <title>MEGACOURS Espace Formateurs</title>
        <!-- Bootstrap Core CSS -->
        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                ...
                <div id="loginbox"  class="mainbox"> 
                    <h3 class="hidden-sm hidden-md hidden-lg  title">Espace connection Formateur.</h3>  
                    <h1 class="hidden-xs title">Espace connection Formateur.</h1>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-heading"  >                                
                            <img src="http://mega-cours.fr/media/images/img_login.png"  class="img-responsive" alt="espace_formateur"  style="margin-left:37%  " />
                        ...
                        <div style="padding-top:5px" class="panel-body" >
                            ...
                            <form name="identification" id="identification"  class="form-signin" method="POST"  role="form"	action="<?= url_espace_formateur ?>/traitement_login_formateur.php">
