        ...
        <script type="text/javascript" language="javascript" >
            $(document).ready(function () {
                var dataTable = $('#employee-grid').DataTable({
                    ...
                    ajax: {
                        url: "service.php?action=GetDonneeAjax", // json datasource
                ...
                function myCallbackFunction(updatedCell, updatedRow, oldValue) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "service.php?action=UpdateDonneeAjax",
                ...
                $('#deleteTriger').on("click", function (event) { // triggering delete one by one
                    if ($('.deleteRow:checked').length > 0) {  // at-least one checkbox checked
                        ...
                        $.ajax({
                            type: "POST",
                            url: "service.php?action=DeleteDonneeAjax",
    ...
    <body>
        ...
        <div class="container">
            <table id="employee-grid"  cellpadding="0" cellspacing="0" border="0" class="display" width="100%"   style="text-align:center">
                ...
                <thead>
                    <tr>
                        <th><input type="checkbox"  id="bulkDelete"  /> <button id="deleteTriger">Supprimer</button></th>
