...
function list_exercices($keygen_theme) {
    global $cxn;
    $liste = array();
    ...
    try {
        ...
        $sql = " SELECT  Liste_plate_formes_codes.nom_plate_forme,Exercices_themes.titre_exo,Exercices_themes.contenu_exo,Exercices_themes.keygen_exo,Exercices_themes.img_exo"
                . ",Exercices_themes.Codefiddle_Corrige,Exercices_themes.Corrige_text "
                . "FROM  Exercices_themes,Liste_plate_formes_codes   WHERE  Exercices_themes.id_plate_forme=Liste_plate_formes_codes.id_plate_forme   AND   Exercices_themes.fk_theme=:param1   ";
